...
object Blacklist_Issue {
    ...
    class Initiator(val blackParty: Party,
        ...
        override fun call(): SignedTransaction {
            ...
            val blackState = BlacklistState(blackParty,escrow,1)
            val blackOutputStateAndContract = StateAndContract(blackState, BlacklistContract.BLACK_CONTRACT_ID)
            val txCommand = Command(BlacklistContract.Commands.BlackIssue(), blackState.participants.map { it.owningKey })
            ...
            val flowBlackParty = initiateFlow(blackParty)
